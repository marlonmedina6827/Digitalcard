...
export function AddEditProductForm(props) {
    ...
    const [previewImage, setPreviewImaget] = useState(product ? product?.image : null);
    ...
    const onDrop = useCallback(async (acceptedFile) => {
        ...
        setPreviewImaget(URL.createObjectURL(file));
    }, [])
  ...
  return (
    <Form className='add-edit-product-form' onSubmit={formik.handleSubmit}>
        ...
        <Dropdown placeholder='Categoría' fluid selection search options={categoriesFormat} value={formik.values.category} error={formik.errors.category} onChange={(_, data) => formik.setFieldValue('category', data.value)}/>
